...
import com.zjj.disk.service.IUserService;
import com.zjj.disk.utils.*;
...
public class UserServiceimpl extends ServiceImpl<UserMapper, User> implements IUserService {
    ...
    public Result cancelAccount() {
        ...
        if (this.allowCancelAccount){
            ...
            LambdaQueryWrapper<com.zjj.disk.pojo.File> lambdaQueryWrapper = new LambdaQueryWrapper<>();
            lambdaQueryWrapper.eq(com.zjj.disk.pojo.File::getCreatorId, loginId);
